...
class UPLTrainer(TrainerX):
    ...
    def zero_shot_analyze(self, trainer_list=None):
        ...
        save_outputs(self.train_loader_sstrain, self, predict_label_dict, self.cfg.DATASET.NAME, text_features, backbone_name=self.cfg.MODEL.BACKBONE.NAME, specific_folder="./temp_analyze_results_miltiple/analyze_results")  # train_loader_x -> train_loader_sstrain
    ...
    def zero_shot_analyze_TEMPLATES(self, trainer_list=None):
        ...
        save_outputs(self.train_loader_sstrain, self, predict_label_dict, self.cfg.DATASET.NAME, text_features,
                     backbone_name=self.cfg.MODEL.BACKBONE.NAME, specific_folder="./temp_analyze_results_miltiple/analyze_results_TEMPLATES")  # train_loader_x -> train_loader_sstrain
        caculate_noise_rate_analyze(predict_label_dict, train_loader=self.train_loader_sstrain, trainer=self)
        return predict_label_dict
